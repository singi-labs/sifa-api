...
describe('PDS writer', () => {
  it('builds create operation', () => {
    const op = buildApplyWritesOp('create', 'id.sifa.profile.position', '3abc', { title: 'Engineer' });
  ...
  it('builds update operation', () => {
    const op = buildApplyWritesOp('update', 'id.sifa.profile.position', '3abc', { title: 'Senior Engineer' });
  ...
  it('sets $type on record value matching collection', () => {
    const op = buildApplyWritesOp('create', 'id.sifa.profile.skill', '3xyz', { name: 'TypeScript' });
